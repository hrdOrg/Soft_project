...
import softwareProject.Feed;
import softwareProject.client;
import softwareProject.feedback;
import softwareProject.improvement;
import softwareProject.instructor;
import softwareProject.program;
import softwareProject.rate;
...
*/
	...
	public void the_system_should_display_the9723_programs_matching_the_selected_filters10(String string, String string2) {
	    assertTrue(c.msg.equals("there is no program with this requirement"));
	}
	...
	public void the_client56y_is_logged_in() {
		 System.out.println("here in test");
	}

	@When("the client check their hhg734 profile with personal details like {string}")
	public void the_client_check_their_hhg734_profile_with_personal_details_like(String string) {
	    
	}

	@Then("the system should return fg&*^%j the requierd personal details like {string}")
	public void the_system_should_return_fg_j_the_requierd_personal_details_like(String string) {

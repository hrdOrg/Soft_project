...
public class Testfilters {
	public static final Logger logger = Logger.getLogger(Testfilters.class.getName());
	
	public instructor n = new instructor();
	
	public List<program> allPrograms = new ArrayList<program>();
    public List<program> filteredPrograms = new ArrayList<program>();
...
*/
    ...
    public void the_system_should_dispply_the_programs_matching_the_selected_filters4(String string) {
       assertTrue(testclient.msg.equals("there is no program with this requirements"));
    }
